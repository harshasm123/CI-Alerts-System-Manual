...
echo ""
echo "📝 Next Steps:"
echo "1. Deploy frontend: bash deploy-cognito-frontend.sh"
echo "2. Create test user (see QUICKSTART.md)"
echo "3. Enable Bedrock models: AWS Console → Bedrock → Model Access"
if [ "$SKIP_CICD" = true ]; then
